...
public class TasksNotAssignedFragment extends Fragment
{
    private ArrayList<TaskModel> taskListArray; //NEED THIS PASSED
    private Context context;

    public static TasksNotAssignedFragment newInstance() { return new TasksNotAssignedFragment();}

    //default
    public TasksNotAssignedFragment()
    {
    ...
    class ViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener
    {
        ...
        public void onClick(View v)
        {
            ...
            intent.putExtra("taskIcon", taskIcon.getId());
